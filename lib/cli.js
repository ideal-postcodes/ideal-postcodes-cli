...
var IdealPostcodes = require("ideal-postcodes");
...
function checkAndApplyKeys (params) {
	...
	if (typeof key === "undefined") {
		console.log(chalk.red("Connecting to the API requires a valid key."));
	...
	if (typeof secret === "undefined") {
		console.log(chalk.red("Connecting to the API requires a secret key to identify your account."));
